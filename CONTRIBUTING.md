...
The team at Runtime welcomes contributions from the community. There are many ways to get involved!
...
> - Star the project
> - Tweet about it
> - Contribute to our [Docs](https://github.com/hanzoai/docs/)
...
[Runtime Code of Conduct](https://github.com/hanzoai/runtime?tab=coc-ov-file#readme).
By participating, you are expected to uphold this code. Please report unacceptable behavior
to [info@hanzo.ai](mailto:info@hanzo.ai).

## Provide Feedback

You might find things that can be improved while you are using Runtime. You can help by [submitting an issue](https://github.com/hanzoai/runtime/issues/new) when:

- A new feature or an enhancement to an existing feature will improve the utility or usability of Runtime.
- Runtime crashes, or you encounter a bug that can only be resolved by restarting Runtime.
...
- Helping other users on [Runtime Community Slack](https://go.hanzo.ai/slack).
- Improving [documentation](https://github.com/hanzoai/docs/)
- Participating in general discussions about development and DevOps
- Authoring new Runtime Plugins and sharing those Plugins
- Authoring new dev containers and sharing examples

## Contributing Code

You can contribute to Runtime by:

- Enhancing current functionality
- Fixing bugs
- Adding new features and capabilities

Before starting your contribution, especially for core features, we encourage you to reach out to us on [Slack](https://go.hanzo.ai/slack). This allows us to ensure that your proposed feature aligns with the project's roadmap and goals. Developers are the key to making Runtime the best tool it can be, and we value input from the community.

We look forward to working with you to improve Runtime and make development environments as easy as possible for developers everywhere.

### Steps to Contribute Code

Follow the following steps to ensure your contribution goes smoothly.

1. Read and follow the steps outlined in the [Runtime Contributing Policy](README.md#contributing).
...
1. Create a [GitHub issue](https://github.com/hanzoai/runtime/issues) if one doesn't exist already.
...
1. Ensure to generate new docs after making command related changes, by running `./hack/generate-cli-docs.sh` in the runtime root directory.
1. Ensure to generate a new API client after making changes related to the API spec, by running `./hack/swagger.sh` in the runtime root directory.
1. Ensure that you have no lint errors. We use `golangci-lint` as our linter which you can install by following instructions found [here](https://golangci-lint.run/welcome/install/#local-installation) (or simply open Runtime in a Dev Container). You can check for linting errors by running `golangci-lint run` in the root of the project.
...
1. A member of the Runtime team will review your PR within three business days (excluding any holidays) and either merge, comment, and/or assign someone for review.
...
1. After completing your review, a Runtime team member will trigger merge to run all tests. Upon passing, your change will be merged into `main`, and your pull requests will be closed. All merges to `main` create a new release, and all final changes are attributed to you.
...
For more information, see the [README](README.md) and feel free to reach out to us on [Slack](https://go.hanzo.ai/slack).
