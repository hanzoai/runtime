# Contributing to Runtime Documentation

Thank you for your interest in contributing to Runtime Documentation! Whether you're fixing a typo, improving existing docs, or adding new content, your help is greatly appreciated.

We are happy to provide guidance on PRs, technical writing, and turning any feature idea into a reality.

This document provides a detailed guide for contributors, especially writers, to ensure that contributions are consistent and of high quality. If you need further assistance, don't hesitate to reach out in the [Runtime Slack Community][slack].
...
1. **Familiarize Yourself**: Begin by understanding Runtime and its features. Explore the existing documentation to get a sense of the writing style and structure.
...
### Contributing using Runtime

To contribute using Runtime, follow these steps:

1. **Fork the Docs repo**: Fork the [Runtime Docs repository][sl] to your GitHub account to create an isolated copy where you can work without affecting the original project.
2. **Access Runtime**: Start a new workspace using the GitHub repositor link and Runtime URL of your Runtime instance, for example '<https://YOUR-RUNTIME.INSTANCE/#https://github.com/YOUR-USERNAME/docs>'. If you don't have access to Runtime you can easily [install](https://github.com/hanzoai/installer) it on your own server. Now, start a workspace through a Runtime dashboard. Optionally, you can install a preferred [Runtime extension](https://download.hanzo.ai/) in your IDE.
...
7. **Open a Pull Request**: Create a pull request from your fork to the main Runtime Docs repository for review.

### Contributing using the Local Environment

To set up and contribute using your local environment, follow these steps:

1. **Fork and Clone**: Fork the [Runtime Docs repository][sl] to your GitHub account and clone it to your local machine.
...
This cheat sheet provides the essential Git commands necessary for contributing to the Runtime Documentation as specified in the previous sections.
...
# Clone your forked repository to your local machine, when using Runtime this is done automatically when creating workspace
...
git remote add upstream https://github.com/hanzoai/docs.git
...
git commit -m "Add a guide on integrating Runtime with VS Code"
```
...
- Create the first translated page for your language.  
   This must be the Runtime Docs landing page: `docs/src/content/docs/{language}/index.mdx`.
- Open a pull request on GitHub to add your changes to Runtime Docs!
...
[issues]: https://github.com/hanzoai/docs/issues
[sl]: https://github.com/hanzoai/docs/pulls
