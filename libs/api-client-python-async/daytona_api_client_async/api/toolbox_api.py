...
from runtime_api_client_async.api_client import ApiClient, RequestSerialized
from runtime_api_client_async.api_response import ApiResponse
from runtime_api_client_async.rest import RESTResponseType
...
class ToolboxApi:
    ...
    def _click_mouse_serialize(
        ...
        if x_hanzo_runtime_organization_id is not None:
            _header_params['X-Runtime-Organization-ID'] = x_hanzo_runtime_organization_id
