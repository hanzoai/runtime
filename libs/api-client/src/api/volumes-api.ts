...
export const VolumesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async deleteVolume(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteVolume(volumeId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async getVolume(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getVolume(volumeId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async getVolumeByName(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getVolumeByName(name, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const VolumesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    createVolume(
      ...
      return localVarFp
        .createVolume(createVolume, xRuntimeOrganizationID, options)
    ...
    deleteVolume(
      ...
      return localVarFp
        .deleteVolume(volumeId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getVolume(
      ...
      return localVarFp.getVolume(volumeId, xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Get volume details by name
    ...
    getVolumeByName(
      ...
      return localVarFp
        .getVolumeByName(name, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listVolumes(
      ...
      return localVarFp
        .listVolumes(xRuntimeOrganizationID, includeDeleted, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class VolumesApi extends BaseAPI {
   ...
   * @memberof VolumesApi
   */
  public createVolume(createVolume: CreateVolume, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
   ...
   * @memberof VolumesApi
   */
  public deleteVolume(volumeId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return VolumesApiFp(this.configuration)
      .deleteVolume(volumeId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof VolumesApi
   */
  public getVolume(volumeId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return VolumesApiFp(this.configuration)
      .getVolume(volumeId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof VolumesApi
   */
  public getVolumeByName(name: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return VolumesApiFp(this.configuration)
      .getVolumeByName(name, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof VolumesApi
   */
  public listVolumes(xRuntimeOrganizationID?: string, includeDeleted?: boolean, options?: RawAxiosRequestConfig) {
    return VolumesApiFp(this.configuration)
      .listVolumes(xRuntimeOrganizationID, includeDeleted, options)
      .then((request) => request(this.axios, this.basePath))
  }
