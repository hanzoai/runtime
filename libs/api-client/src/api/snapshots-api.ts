...
export const SnapshotsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async activateSnapshot(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.activateSnapshot(id, xRuntimeOrganizationID, options)
    ...
    async getSnapshot(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSnapshot(id, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async removeSnapshot(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.removeSnapshot(id, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const SnapshotsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    activateSnapshot(
      ...
      return localVarFp
        .activateSnapshot(id, xRuntimeOrganizationID, options)
    ...
    createSnapshot(
      ...
      return localVarFp
        .createSnapshot(createSnapshot, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getAllSnapshots(
      ...
      return localVarFp
        .getAllSnapshots(xRuntimeOrganizationID, limit, page, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getSnapshot(
      ...
      return localVarFp.getSnapshot(id, xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Get snapshot build logs
    ...
    getSnapshotBuildLogs(
      ...
      return localVarFp
        .getSnapshotBuildLogs(id, xRuntimeOrganizationID, follow, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    removeSnapshot(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
      return localVarFp.removeSnapshot(id, xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Set snapshot general status
    ...
    setSnapshotGeneralStatus(
      ...
      return localVarFp
        .setSnapshotGeneralStatus(id, setSnapshotGeneralStatusDto, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    toggleSnapshotState(
      ...
      return localVarFp
        .toggleSnapshotState(id, toggleState, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class SnapshotsApi extends BaseAPI {
   ...
   */
  public activateSnapshot(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
   ...
   * @memberof SnapshotsApi
   */
  public getSnapshot(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SnapshotsApiFp(this.configuration)
      .getSnapshot(id, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof SnapshotsApi
   */
  public removeSnapshot(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SnapshotsApiFp(this.configuration)
      .removeSnapshot(id, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
