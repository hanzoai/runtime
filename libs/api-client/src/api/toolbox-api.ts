...
export const ToolboxApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getWindows(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getWindows(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async listSessions(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.listSessions(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async uploadFiles(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.uploadFiles(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const ToolboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    clickMouse(
      ...
      return localVarFp
        .clickMouse(sandboxId, mouseClickRequest, xRuntimeOrganizationID, options)
    ...
    createFolder(
      ...
      return localVarFp
        .createFolder(sandboxId, path, mode, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Create a new session in the sandbox
    ...
    createSession(
      ...
      return localVarFp
        .createSession(sandboxId, createSessionRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Delete file inside sandbox
    ...
    deleteFile(
      ...
      return localVarFp
        .deleteFile(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Delete a specific session
    ...
    deleteSession(
      ...
      return localVarFp
        .deleteSession(sandboxId, sessionId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Download file from sandbox
    ...
    downloadFile(
      ...
      return localVarFp
        .downloadFile(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Drag mouse from start to end coordinates
    ...
    dragMouse(
      ...
      return localVarFp
        .dragMouse(sandboxId, mouseDragRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Execute command synchronously inside sandbox
    ...
    executeCommand(
      ...
      return localVarFp
        .executeCommand(sandboxId, executeRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Execute a command in a specific session
    ...
    executeSessionCommand(
      ...
      return localVarFp
        .executeSessionCommand(sandboxId, sessionId, sessionExecuteRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Search for text/pattern inside sandbox files
    ...
    findInFiles(
      ...
      return localVarFp
        .findInFiles(sandboxId, path, pattern, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get status of all VNC desktop processes
    ...
    getComputerUseStatus(
      ...
      return localVarFp
        .getComputerUseStatus(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get information about displays
    ...
    getDisplayInfo(
      ...
      return localVarFp
        .getDisplayInfo(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get file info inside sandbox
    ...
    getFileInfo(
      ...
      return localVarFp
        .getFileInfo(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get current mouse cursor position
    ...
    getMousePosition(
      ...
      return localVarFp
        .getMousePosition(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get error logs for a specific VNC process
    ...
    getProcessErrors(
      ...
      return localVarFp
        .getProcessErrors(processName, sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get logs for a specific VNC process
    ...
    getProcessLogs(
      ...
      return localVarFp
        .getProcessLogs(processName, sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get status of a specific VNC process
    ...
    getProcessStatus(
      ...
      return localVarFp
        .getProcessStatus(processName, sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getProjectDir(
      ...
      return localVarFp
        .getProjectDir(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get session by ID
    ...
    getSession(
      ...
      return localVarFp
        .getSession(sandboxId, sessionId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get session command by ID
    ...
    getSessionCommand(
      ...
      return localVarFp
        .getSessionCommand(sandboxId, sessionId, commandId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get logs for a specific command in a session
    ...
    getSessionCommandLogs(
      ...
      return localVarFp
        .getSessionCommandLogs(sandboxId, sessionId, commandId, xRuntimeOrganizationID, follow, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get list of open windows
    ...
    getWindows(
      ...
      return localVarFp
        .getWindows(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Add files to git commit
    ...
    gitAddFiles(
      ...
      return localVarFp
        .gitAddFiles(sandboxId, gitAddRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Checkout branch or commit in git repository
    ...
    gitCheckoutBranch(
      ...
      return localVarFp
        .gitCheckoutBranch(sandboxId, gitCheckoutRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Clone git repository
    ...
    gitCloneRepository(
      ...
      return localVarFp
        .gitCloneRepository(sandboxId, gitCloneRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Commit changes to git repository
    ...
    gitCommitChanges(
      ...
      return localVarFp
        .gitCommitChanges(sandboxId, gitCommitRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Create branch on git repository
    ...
    gitCreateBranch(
      ...
      return localVarFp
        .gitCreateBranch(sandboxId, gitBranchRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Delete branch on git repository
    ...
    gitDeleteBranch(
      ...
      return localVarFp
        .gitDeleteBranch(sandboxId, gitDeleteBranchRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get commit history from git repository
    ...
    gitGetHistory(
      ...
      return localVarFp
        .gitGetHistory(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get status from git repository
    ...
    gitGetStatus(
      ...
      return localVarFp
        .gitGetStatus(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Get branch list from git repository
    ...
    gitListBranches(
      ...
      return localVarFp
        .gitListBranches(sandboxId, path, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Pull changes from remote
    ...
    gitPullChanges(
      ...
      return localVarFp
        .gitPullChanges(sandboxId, gitRepoRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Push changes to remote
    ...
    gitPushChanges(
      ...
      return localVarFp
        .gitPushChanges(sandboxId, gitRepoRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listFiles(
      ...
      return localVarFp
        .listFiles(sandboxId, xRuntimeOrganizationID, path, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * List all active sessions in the sandbox
    ...
    listSessions(
      ...
      return localVarFp
        .listSessions(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * The Completion request is sent from the client to the server to compute completion items at a given cursor position.
    ...
    lspCompletions(
      ...
      return localVarFp
        .lspCompletions(sandboxId, lspCompletionParams, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * The document close notification is sent from the client to the server when the document got closed in the client.
    ...
    lspDidClose(
      ...
      return localVarFp
        .lspDidClose(sandboxId, lspDocumentRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * The document open notification is sent from the client to the server to signal newly opened text documents.
    ...
    lspDidOpen(
      ...
      return localVarFp
        .lspDidOpen(sandboxId, lspDocumentRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * The document symbol request is sent from the client to the server.
    ...
    lspDocumentSymbols(
      ...
      return localVarFp
        .lspDocumentSymbols(sandboxId, languageId, pathToProject, uri, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Start Lsp server process inside sandbox project
    ...
    lspStart(
      ...
      return localVarFp
        .lspStart(sandboxId, lspServerRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Stop Lsp server process inside sandbox project
    ...
    lspStop(
      ...
      return localVarFp
        .lspStop(sandboxId, lspServerRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * The workspace symbol request is sent from the client to the server to list project-wide symbols matching the query string.
    ...
    lspWorkspaceSymbols(
      ...
      return localVarFp
        .lspWorkspaceSymbols(sandboxId, languageId, pathToProject, query, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Move file inside sandbox
    ...
    moveFile(
      ...
      return localVarFp
        .moveFile(sandboxId, source, destination, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Move mouse cursor to specified coordinates
    ...
    moveMouse(
      ...
      return localVarFp
        .moveMouse(sandboxId, mouseMoveRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Press a hotkey combination
    ...
    pressHotkey(
      ...
      return localVarFp
        .pressHotkey(sandboxId, keyboardHotkeyRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Press a key with optional modifiers
    ...
    pressKey(
      ...
      return localVarFp
        .pressKey(sandboxId, keyboardPressRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Replace text/pattern in multiple files inside sandbox
    ...
    replaceInFiles(
      ...
      return localVarFp
        .replaceInFiles(sandboxId, replaceRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Restart a specific VNC process
    ...
    restartProcess(
      ...
      return localVarFp
        .restartProcess(processName, sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Scroll mouse at specified coordinates
    ...
    scrollMouse(
      ...
      return localVarFp
        .scrollMouse(sandboxId, mouseScrollRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Search for files inside sandbox
    ...
    searchFiles(
      ...
      return localVarFp
        .searchFiles(sandboxId, path, pattern, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Set file owner/group/permissions inside sandbox
    ...
    setFilePermissions(
      ...
      return localVarFp
        .setFilePermissions(sandboxId, path, xRuntimeOrganizationID, owner, group, mode, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Start all VNC desktop processes (Xvfb, xfce4, x11vnc, novnc)
    ...
    startComputerUse(
      ...
      return localVarFp
        .startComputerUse(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Stop all VNC desktop processes (Xvfb, xfce4, x11vnc, novnc)
    ...
    stopComputerUse(
      ...
      return localVarFp
        .stopComputerUse(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Take a compressed screenshot of a specific region
    ...
    takeCompressedScreenshot(
      ...
      return localVarFp
        .takeCompressedScreenshot(sandboxId, xRuntimeOrganizationID, scale, quality, format, showCursor, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Take a screenshot of a specific region
    ...
    takeRegionScreenshot(
      ...
      return localVarFp
        .takeRegionScreenshot(sandboxId, height, width, y, x, xRuntimeOrganizationID, showCursor, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Take a screenshot of the entire screen
    ...
    takeScreenshot(
      ...
      return localVarFp
        .takeScreenshot(sandboxId, xRuntimeOrganizationID, showCursor, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Type text using keyboard
    ...
    typeText(
      ...
      return localVarFp
        .typeText(sandboxId, keyboardTypeRequest, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Upload file inside sandbox
    ...
    uploadFile(
      ...
      return localVarFp
        .uploadFile(sandboxId, path, xRuntimeOrganizationID, file, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * Upload multiple files inside sandbox
    ...
    uploadFiles(
      ...
      return localVarFp
        .uploadFiles(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ToolboxApi extends BaseAPI {
   ...
   * @memberof ToolboxApi
   */
  public deleteFile(sandboxId: string, path: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .deleteFile(sandboxId, path, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public getComputerUseStatus(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .getComputerUseStatus(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public getDisplayInfo(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .getDisplayInfo(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public getMousePosition(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .getMousePosition(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public getProjectDir(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .getProjectDir(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public getWindows(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .getWindows(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public listFiles(sandboxId: string, xRuntimeOrganizationID?: string, path?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .listFiles(sandboxId, xRuntimeOrganizationID, path, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public listSessions(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .listSessions(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public startComputerUse(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .startComputerUse(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public stopComputerUse(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .stopComputerUse(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof ToolboxApi
   */
  public uploadFiles(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return ToolboxApiFp(this.configuration)
      .uploadFiles(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
