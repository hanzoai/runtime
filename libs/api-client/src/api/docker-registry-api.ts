...
export const DockerRegistryApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async deleteRegistry(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRegistry(id, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async getRegistry(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getRegistry(id, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async getTransientPushAccess(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTransientPushAccess(xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async listRegistries(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.listRegistries(xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async setDefaultRegistry(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.setDefaultRegistry(id, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const DockerRegistryApiFactory = function (
  ...
  return {
    ...
    createRegistry(
      ...
      return localVarFp
        .createRegistry(createDockerRegistry, xRuntimeOrganizationID, options)
     ...
     * @throws {RequiredError}
     */
    deleteRegistry(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
      return localVarFp.deleteRegistry(id, xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Get registry
    ...
    getRegistry(
      ...
      return localVarFp.getRegistry(id, xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Get temporary registry access for pushing snapshots
    ...
    getTransientPushAccess(
      ...
      return localVarFp
        .getTransientPushAccess(xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listRegistries(
      ...
      return localVarFp.listRegistries(xRuntimeOrganizationID, options).then((request) => request(axios, basePath))
    },
    /**
     *
     * @summary Set default registry
    ...
    setDefaultRegistry(
      ...
      return localVarFp
        .setDefaultRegistry(id, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updateRegistry(
      ...
      return localVarFp
        .updateRegistry(id, updateDockerRegistry, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class DockerRegistryApi extends BaseAPI {
   ...
   * @memberof DockerRegistryApi
   */
  public deleteRegistry(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .deleteRegistry(id, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof DockerRegistryApi
   */
  public getRegistry(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .getRegistry(id, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof DockerRegistryApi
   */
  public getTransientPushAccess(xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .getTransientPushAccess(xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof DockerRegistryApi
   */
  public listRegistries(xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .listRegistries(xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof DockerRegistryApi
   */
  public setDefaultRegistry(id: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return DockerRegistryApiFp(this.configuration)
      .setDefaultRegistry(id, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
