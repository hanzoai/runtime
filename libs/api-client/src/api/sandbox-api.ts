...
export const SandboxApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createBackup(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.createBackup(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async startSandbox(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.startSandbox(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    async stopSandbox(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.stopSandbox(sandboxId, xRuntimeOrganizationID, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const SandboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    archiveSandbox(
      ...
      return localVarFp
        .archiveSandbox(sandboxId, xRuntimeOrganizationID, options)
    ...
    createBackup(
      ...
      return localVarFp
        .createBackup(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    createSandbox(
      ...
      return localVarFp
        .createSandbox(createSandbox, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    deleteSandbox(
      ...
      return localVarFp
        .deleteSandbox(sandboxId, force, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getBuildLogs(
      ...
      return localVarFp
        .getBuildLogs(sandboxId, xRuntimeOrganizationID, follow, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getPortPreviewUrl(
      ...
      return localVarFp
        .getPortPreviewUrl(sandboxId, port, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getSandbox(
      ...
      return localVarFp
        .getSandbox(sandboxId, xRuntimeOrganizationID, verbose, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    listSandboxes(
      ...
      return localVarFp
        .listSandboxes(xRuntimeOrganizationID, verbose, labels, includeErroredDeleted, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    replaceLabels(
      ...
      return localVarFp
        .replaceLabels(sandboxId, sandboxLabels, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutoArchiveInterval(
      ...
      return localVarFp
        .setAutoArchiveInterval(sandboxId, interval, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutoDeleteInterval(
      ...
      return localVarFp
        .setAutoDeleteInterval(sandboxId, interval, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    setAutostopInterval(
      ...
      return localVarFp
        .setAutostopInterval(sandboxId, interval, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    startSandbox(
      ...
      return localVarFp
        .startSandbox(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    stopSandbox(
      ...
      return localVarFp
        .stopSandbox(sandboxId, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    updatePublicStatus(
      ...
      return localVarFp
        .updatePublicStatus(sandboxId, isPublic, xRuntimeOrganizationID, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class SandboxApi extends BaseAPI {
   ...
   * @memberof SandboxApi
   */
  public archiveSandbox(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
   ...
   * @memberof SandboxApi
   */
  public createBackup(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SandboxApiFp(this.configuration)
      .createBackup(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof SandboxApi
   */
  public createSandbox(createSandbox: CreateSandbox, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SandboxApiFp(this.configuration)
      .createSandbox(createSandbox, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof SandboxApi
   */
  public startSandbox(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SandboxApiFp(this.configuration)
      .startSandbox(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof SandboxApi
   */
  public stopSandbox(sandboxId: string, xRuntimeOrganizationID?: string, options?: RawAxiosRequestConfig) {
    return SandboxApiFp(this.configuration)
      .stopSandbox(sandboxId, xRuntimeOrganizationID, options)
      .then((request) => request(this.axios, this.basePath))
  }
